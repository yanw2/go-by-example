...
func main() {
	...
	// This prints an instance of `point` struct
	fmt.Printf("%v\n", p)
	...
	// To specify the width of an integer, use a number after the % in the verb. By default, the result will
	// be right-justified and padded with spaces.
	fmt.Printf("|%6d|%6d|\n", 12, 345)
